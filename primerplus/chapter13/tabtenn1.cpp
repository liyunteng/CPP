...
TabelTennisPlayer::TabelTennisPlayer(const string &fn, const string &ln,
                                     bool ht) :
    firstName(fn),
    lastName(ln),
    hasTabel(ht)
...
RetedPlayer::RetedPlayer(unsigned int r, const string &fn, const string &ln,
                         bool ht) :
    TabelTennisPlayer(fn, ln, ht),
    rating(r)
{
}
