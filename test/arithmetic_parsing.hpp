...
private:
    ...
    bool find_cs(const std::string &input, std::string::size_type start, std::string::size_type &end,
                 std::stack<std::string>&s1, std::stack<std::string> &s2, bool &valid);
    bool find_pair(const std::string &input, std::string::size_type start, std::string::size_type &end);
