...
bool parser::is_sub(const string &input)
{
    if (input.empty()) {
        return false;
    }
...
bool parser::find_pair(const string &input, string::size_type start, string::size_type &end)
{
    if (input.empty()) {
        return false;
    }
...
// find sin/cos
bool parser::find_cs(const string &in, string::size_type idx, string::size_type &end,
...
float parser::eval_cs(const string&input)
{
    if (input.empty()) {
        return 0.0;
    }
...
float parser::eval(stack<string> &operand_stack, stack<string> &operator_stack)
{
    string op;
    string s;
...
float parser::parse_sub(const string &input, bool &valid)
{
    string in = input;
    trim(in);
    string::size_type idx = 0, end = 0;
...
float parser::parse(const string &input)
{
    if (input.empty()) {
        return 0.0;
    }
